...
모르는 개념이 생길 때마다 텔레그램 봇에 *"FDE"* 처럼 한 줄을 보내면, 약 60초 뒤 봇이 **나만의 과외 노트 같은 카드뉴스 8장**을 앨범으로 답장합니다. 이해가 됐다 싶으면 `📤 인스타 아카이브` 버튼을 눌러 [@what_is_this.zip](https://instagram.com/what_is_this.zip)에 남겨둡니다 — 나중에 다시 꺼내 볼 수 있게.
